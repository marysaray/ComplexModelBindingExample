...
using ComplexModelBindingExample.Data;
using ComplexModelBindingExample.Models;

namespace ComplexModelBindingExample.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Category")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Category")] EventType eventType)
        {
            if (id != eventType.Id)
            {
                return NotFound();
